...
class ItalianRecepies : AppCompatActivity() {
        ...
        db.collection("Italian_recepies")
            ...
            .addOnSuccessListener { documents ->
                ...
                for (document in documents) {
                    ...
                    addBreakfastItem(italianrecepies)
                }
            }
    ...
    private fun addBreakfastItem(italianrecipies: String) {
        val brunchContainer = findViewById<LinearLayout>(R.id.italianrecepiesContainer)

        val button = Button(this)
        button.text = italianrecipies
        ...
        button.setOnClickListener {
            ...
            intent.putExtra("BREAKFAST_NAME", italianrecipies)
