...
class MexicanRecepies : AppCompatActivity() {
        ...
        db.collection("Mexician_recepies")
            ...
            .addOnSuccessListener { documents ->
                ...
                for (document in documents) {
                    val mexicanrecepies = document.id
                    addBreakfastItem(mexicanrecepies)
                }
            }
    ...
    private fun addBreakfastItem(mexicanrecipename: String) {
        val brunchContainer = findViewById<LinearLayout>(R.id.mexicanrecepiesContainer)

        val button = Button(this)
        button.text = mexicanrecipename
        ...
        button.setOnClickListener {
            ...
            intent.putExtra("BREAKFAST_NAME", mexicanrecipename)
